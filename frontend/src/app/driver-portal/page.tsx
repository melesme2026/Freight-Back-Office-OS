    ...
    <main className="safe-page min-h-screen bg-slate-50 text-slate-900">
      <div className="mx-auto max-w-6xl px-4 py-6 sm:px-6 sm:py-10">
        <div className="mb-8">
          ...
          <h1 className="text-2xl font-bold tracking-tight text-slate-950 sm:text-3xl">Driver Workspace</h1>
        ...
        <section className="mt-8 grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          <Link
            ...
            className="touch-target rounded-2xl border border-slate-200 bg-white p-5 shadow-soft"
          >
