...
LOAD_STATUS_WAITING_ON_BROKER = "waiting_on_broker"
LOAD_STATUS_SUBMITTED_TO_FACTORING = "submitted_to_factoring"
LOAD_STATUS_WAITING_ON_FUNDING = "waiting_on_funding"
...
LOAD_STATUSES = (
    ...
    LOAD_STATUS_NEEDS_REVIEW,
    LOAD_STATUS_READY_TO_SUBMIT,
    LOAD_STATUS_SUBMITTED_TO_BROKER,
    LOAD_STATUS_WAITING_ON_BROKER,
    LOAD_STATUS_SUBMITTED_TO_FACTORING,
    LOAD_STATUS_WAITING_ON_FUNDING,
    LOAD_STATUS_FUNDED,
    LOAD_STATUS_PAID,
    LOAD_STATUS_EXCEPTION,
