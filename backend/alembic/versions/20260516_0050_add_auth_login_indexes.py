...
def upgrade() -> None:
    if not _index_exists("ix_staff_users_email_active_role", "staff_users"):
        op.create_index(
    ...
    if not _index_exists("ix_staff_users_org_lower_email", "staff_users"):
        op.create_index(
    ...
    if not _index_exists("ix_staff_users_lower_email_org", "staff_users"):
        op.create_index(
    ...
    if not _index_exists("ix_drivers_org_email_active", "drivers"):
        op.create_index(
    ...
    if not _index_exists("ix_drivers_org_lower_email", "drivers"):
        op.create_index(
    ...
    if not _index_exists("ix_drivers_lower_email_org", "drivers"):
        op.create_index(
...
def downgrade() -> None:
    if _index_exists("ix_drivers_lower_email_org", "drivers"):
        op.drop_index("ix_drivers_lower_email_org", table_name="drivers")
    if _index_exists("ix_drivers_org_lower_email", "drivers"):
        op.drop_index("ix_drivers_org_lower_email", table_name="drivers")
    if _index_exists("ix_drivers_org_email_active", "drivers"):
        op.drop_index("ix_drivers_org_email_active", table_name="drivers")
    if _index_exists("ix_staff_users_lower_email_org", "staff_users"):
        op.drop_index("ix_staff_users_lower_email_org", table_name="staff_users")
    if _index_exists("ix_staff_users_org_lower_email", "staff_users"):
        op.drop_index("ix_staff_users_org_lower_email", table_name="staff_users")
    if _index_exists("ix_staff_users_email_active_role", "staff_users"):
